...
# Admin Site Title
ADMIN_HEADLINE = getattr(settings, "GRAPPELLI_ADMIN_HEADLINE", 'Prontuario Eletronico')
ADMIN_TITLE = getattr(settings, "GRAPPELLI_ADMIN_TITLE", 'Prontuario Eletronico')
